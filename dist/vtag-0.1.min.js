(function(n){n.vtag={renderers:{}};n.fn.vtag=function(a){var g=a&&a.type||"retro",h=n.vtag.renderers[g];if("function"!=typeof h)return console&&console.log&&console.log("Unknown renderer: "+g),this;this.each(function(){if("function"==typeof this.getContext){for(var g=n(this),l=n.vtag.md5(g.attr("data-tag")||g.text()),m=[],p=0;16>p;p++){var f=l.substring(2*p,2*p+2);m.push(parseInt(f,16))}var g={width:parseInt(g.attr("width")||g.width()),height:parseInt(g.attr("height")||g.height()),hash:l,bytes:m},
r;for(r in a)g[r]=a[r];h.call(this,g)}});return this};n.vtag.md5=function(a){function g(a,b){var c,e,d,f,g;d=a&2147483648;f=b&2147483648;c=a&1073741824;e=b&1073741824;g=(a&1073741823)+(b&1073741823);return c&e?g^2147483648^d^f:c|e?g&1073741824?g^3221225472^d^f:g^1073741824^d^f:g^d^f}function h(a,b,d,c,e,f,h){a=g(a,g(g(b&d|~b&c,e),h));return g(a<<f|a>>>32-f,b)}function k(a,b,d,c,e,f,h){a=g(a,g(g(b&c|d&~c,e),h));return g(a<<f|a>>>32-f,b)}function l(a,b,d,c,e,f,h){a=g(a,g(g(b^d^c,e),h));return g(a<<
f|a>>>32-f,b)}function m(a,b,d,c,e,f,h){a=g(a,g(g(d^(b|~c),e),h));return g(a<<f|a>>>32-f,b)}function p(a){var b="",d="",c;for(c=0;3>=c;c++)d=a>>>8*c&255,d="0"+d.toString(16),b+=d.substr(d.length-2,2);return b}var f=[],n,q,s,t,b,c,e,d;a=function(a){a=a.replace(/\r\n/g,"\n");for(var b="",d=0;d<a.length;d++){var c=a.charCodeAt(d);128>c?b+=String.fromCharCode(c):(127<c&&2048>c?b+=String.fromCharCode(c>>6|192):(b+=String.fromCharCode(c>>12|224),b+=String.fromCharCode(c>>6&63|128)),b+=String.fromCharCode(c&
63|128))}return b}(a);f=function(a){var b,c=a.length;b=c+8;for(var d=16*((b-b%64)/64+1),e=Array(d-1),f=0,g=0;g<c;)b=(g-g%4)/4,f=8*(g%4),e[b]|=a.charCodeAt(g)<<f,g++;b=(g-g%4)/4;e[b]|=128<<8*(g%4);e[d-2]=c<<3;e[d-1]=c>>>29;return e}(a);b=1732584193;c=4023233417;e=2562383102;d=271733878;for(a=0;a<f.length;a+=16)n=b,q=c,s=e,t=d,b=h(b,c,e,d,f[a+0],7,3614090360),d=h(d,b,c,e,f[a+1],12,3905402710),e=h(e,d,b,c,f[a+2],17,606105819),c=h(c,e,d,b,f[a+3],22,3250441966),b=h(b,c,e,d,f[a+4],7,4118548399),d=h(d,b,
